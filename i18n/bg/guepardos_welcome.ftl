...
about-dialog-comments = Начален екран за GuepardOS
...
outdated-version-warning = Използвате по-стара версия на GuepardOS ISO. Моля, обмислете използването на най-новата версия за инсталации.
...
welcome-title = Добре дошли в GuepardOS!
welcome-body =
    Благодарим ви, че се присъединихте към нашата общност!

    Надяваме се, че ще използвате GuepardOS с удоволствие – точно толкова, колкото на нас ни доставя удоволствие да я създаваме. Връзките по-долу ще ви помогнат да започнете работа с новата си операционна система. Насладете се на работата с нея и не се притеснявайте да споделите мнението си.
