...
about-dialog-comments = Schermata di benvenuto per GuepardOS
...
outdated-version-warning = Stai usando una versione obsoleta dell'ISO di GuepardOS, considera di utilizzare l'ultima versione per le installazioni
...
welcome-title = Benvenuto in GuepardOS!
welcome-body =
    Grazie per esserti unito alla nostra comunità!

    Noi, gli sviluppatori di GuepardOS, speriamo che trovi l'utilizzo di GuepardOS altrettanto piacevole quanto lo troviamo noi nello svilupparlo. I collegamenti sottostanti ti aiuteranno a orientarti nel tuo nuovo sistema operativo. Per cui goditi l'esperienza e non esitare a inviarci la tua opinione.
