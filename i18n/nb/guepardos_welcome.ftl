...
about-dialog-comments = Velkomstskjermen til GuepardOS
...
outdated-version-warning = Du bruker en eldre versjon av GuepardOS ISO. Vurder å bruke den nyeste versjonen for installasjoner.
...
welcome-title = Velkommen til GuepardOS!
welcome-body =
   Takk for at du blir med i fellesskapet vårt!

    Vi, GuepardOS-utviklerne, håper at du vil like å bruke GuepardOS like mye som vi liker å bygge det. Lenkene nedenfor vil hjelpe deg med å komme i gang med ditt nye operativsystem. Så nyt opplevelsen, og ikke nøl med å sende oss tilbakemeldingen din.
