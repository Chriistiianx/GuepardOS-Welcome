...
about-dialog-comments = Οθόνη καλωσορίσματος για το GuepardOS
...
outdated-version-warning = Χρησιμοποιείτε μια παλαιότερη έκδοση του ISO του GuepardOS· καλό θα ήταν να χρησιμοποιείτε την τελευταία έκδοση για τις εγκαταστάσεις
...
welcome-title = Καλώς ορίσατε στο GuepardOS!
welcome-body =
    Σας ευχαριστούμε που γίνατε μέλος της κοινότητάς μας!

    Εμείς, οι προγραμματιστές του GuepardOS, ελπίζουμε να ευχαριστηθείτε τη χρήση του GuepardOS όσο ευχαριστιόμαστε κι εμείς την ανάπτυξή του. Οι παρακάτω σύνδεσμοι θα σας βοηθήσουν να ξεκινήσετε με το νέο σας λειτουργικό σύστημα. Απολαύστε λοιπόν την εμπειρία και μην διστάσετε να μας στείλετε τα σχόλιά σας.
