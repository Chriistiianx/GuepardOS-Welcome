...
about-dialog-comments = GuepardOS のようこそ画面
...
outdated-version-warning = 現在古いバージョンの GuepardOS ISO を利用しています。インストールには最新バージョンを利用することをおすすめします
...
welcome-title = GuepardOS へようこそ！
welcome-body =
    コミュニティに参加いただきありがとうございます！

    GuepardOS 開発チーム一同、情熱を持って開発した GuepardOS を皆さまに楽しんでいただけることを願っています。下のリンクは、はじめてこの OS を利用する場合に役立ちます。GuepardOS をぜひご活用ください。フィードバックもお待ちしております。
