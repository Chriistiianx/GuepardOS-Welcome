...
about-dialog-comments = Welcome screen for GuepardOS
...
outdated-version-warning = You are using an older version of GuepardOS ISO, please consider using latest version for installations
...
welcome-title = Welcome to GuepardOS!
welcome-body =
    Este es el Launcher!

    We, the GuepardOS Developers, hope that you will enjoy using GuepardOS as much as we enjoy building it. The links below will help you get started with your new operating system. So enjoy the experience, and don't hesitate to send us your feedback.
