# About dialog
about-dialog-title = GuepardOS Hello
about-dialog-comments = Tela de Boas-Vindas do GuepardOS
...
button-software-label = Aplicações do GuepardOS
button-donate-label = Doar
button-forum-label = Fórum
button-installer-label = Instalar GuepardOS
...
unsupported-hw-warning = Você está tentando instalar o GuepardOS em um hardware incompatível com a versão atual. Sua versão não é elegível para suporte.
...
outdated-version-warning = Você está usando uma versão antiga do GuepardOS, considere instalar uma versão atualizada.
...
welcome-title = Bem-Vindo ao GuepardOS!
welcome-body =
    Obrigado por entrar na nossa comunidade!

    Nós, os desenvolvedores do GuepardOS, esperamos que você goste de usá-lo o tanto quanto gostamos de desenvolvê-lo! Os links abaixo ajudarão você dar os primeiros passos com seu novo sistema operacional. Aproveite a experiência, e não hesite em dar seu feedback!
