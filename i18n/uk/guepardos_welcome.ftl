...
about-dialog-comments = Вітальний екран GuepardOS
...
outdated-version-warning = Ви використовуєте застарілу версію ISO GuepardOS. Рекомендуємо скористатися найновішою
...
welcome-title = Ласкаво просимо до GuepardOS!
welcome-body =
    Дякуємо, що приєдналися до нашої спільноти!

    Ми, команда розробників GuepardOS, сподіваємося, що вам буде так само приємно користуватися цією системою, як нам — створювати її. Посилання нижче допоможуть швидко розпочати роботу. Насолоджуйтесь і не соромтеся ділитися своїми відгуками.
