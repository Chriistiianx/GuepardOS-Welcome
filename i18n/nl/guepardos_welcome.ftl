# About dialog
about-dialog-title = GuepardOS – Hallo
about-dialog-comments = Welkomstscherm van GuepardOS
...
outdated-version-warning = U gebruikt een oudere versie van GuepardOS ISO, overweeg alstublieft de nieuwste versie te gebruiken voor installaties
...
welcome-title = Welkom op GuepardOS!
welcome-body =
    Wat fijn dat we je mogen verwelkomen in onze gemeenschap!

    Wij, de GuepardOS-ontwikkelaars, hopen dat je net zoveel plezier beleeft aan het gebruiken van GuepardOS als wij dat hebben in de ontwikkeling ervan. Met behulp van onderstaande links kun je jezelf wegwijs maken in dit voor jou nieuwe besturingssysteem. Geniet ervan en stuur ons desnoods wat feedback.
