...
about-dialog-comments = Üdvözlőképernyő a GuepardOS-hez
...
outdated-version-warning = Egy régebbi GuepardOS ISO-t használsz, a telepítéshez érdemesebb a legújabb verziót használnod
...
welcome-title = Üdvözlünk a GuepardOS-ben!
welcome-body =
    Köszönjük, hogy csatlakoztál a közösségünkhöz!

    Mi, a GuepardOS fejlesztői reméljük, hogy legalább annyira élvezni fogod a GuepardOS használatát, mint amennyire mi élveztük a megalkotását. Az alábbi linkek segítenek az elindulásban az új operációs rendszerrel. Jó szórakozást, és ne habozz visszajelzést küldeni nekünk!
