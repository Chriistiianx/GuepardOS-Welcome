# About dialog
about-dialog-title = תוכנית קבלת הפנים של GuepardOS
about-dialog-comments = תוכנית קבלת פנים עבור GuepardOS
...
outdated-version-warning = מחשבך מריץ גרסה ישנה של ה־ISO של GuepardOS, נא לשקול להשתמש בגרסה העדכנית לצורך התקנת המערכת
...
welcome-title = ברוך בואך אל GuepardOS!
welcome-body =
    תודה שהצטרפת לקהילה שלנו!

    אנחנו, מפתחי GuepardOS, מקווים שיהיה לך כיף להשתמש ב־GuepardOS כמו שאנחנו נהנים מעבודת הפיתוח שלה. הקישורים הבאים יעזרו לך להתחיל להשתמש במערכת ההפעלה החדשה שלך. מקווים שתהיה לך חוויה מהנה, ולא להסס לשלוח לנו משוב.
