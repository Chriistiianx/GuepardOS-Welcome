...
about-dialog-comments = Pantalla de bienvenida de GuepardOS
...
outdated-version-warning = Se está utilizando una versión antigua de la ISO de GuepardOS; por favor, considere usar la última versión para realizar la instalación.
...
welcome-title = ¡Bienvenido a GuepardOS!
welcome-body =
    ¡Gracias por unirse a nuestra comunidad!

    Quienes desarrollamos GuepardOS deseamos que disfrute este sistema operativo tanto como nosotros disfrutamos creándolo. Los enlaces a continuación le ayudarán a dar sus primeros pasos. Disfrute la experiencia y no dude en enviarnos sus comentarios.
