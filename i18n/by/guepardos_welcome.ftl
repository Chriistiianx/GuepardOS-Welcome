...
about-dialog-comments = Экран прывітання для GuepardOS
...
outdated-version-warning = Вы выкарыстоўваеце старую версію GuepardOS ISO, калі ласка, разгледзьце магчымасць выкарыстання апошняй версіі для ўстаноўкі
...
welcome-title = Сардэчна запрашаем у GuepardOS!
welcome-body =
    Дзякуем за тое, што Вы далучыліся да нашай супольнасці!

    Мы, распрацоўшчыкі GuepardOS, спадзяемся, што карыстаючыся гэтай сістэмай, Вы будзеце адчуваць такое ж задавальненне, якое мы адчувалі, ствараючы яе. Прадстаўленыя ніжэй спасылкі дапамогуць Вам пачаць працу. Атрымлівайце асалоду ад функцыяналам GuepardOS і пакідайце свае водгукі.
