...
about-dialog-comments = GuepardOS pasveikinimo langas
...
outdated-version-warning = Naudojate senesnę GuepardOS ISO versiją; diegdami apsvarstykite galimybę naudoti naujausią versiją
...
welcome-title = Sveiki atvykę į GuepardOS!
welcome-body =
    Ačiū, kad prisijungėte prie mūsų bendruomenės!

    Mes, GuepardOS kūrėjai, tikimės, kad naudotis GuepardOS jums bus taip pat malonu, kaip mums ją kurti. Toliau pateiktos nuorodos padės pradėti darbą su naująja operacine sistema. Tad mėgaukitės patirtimi ir nedvejodami atsiųskite mums savo atsiliepimus.
