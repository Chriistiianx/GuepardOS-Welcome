...
about-dialog-comments = GuepardOS Hoş Geldin Ekranı
...
# Tweaks page — quick launch (GuepardOS apps)
app-GuepardOS-pi-label = GuepardOS Paket Kurucu
app-GuepardOS-kernel-manager-label = GuepardOS Çekirdek Yöneticisi
...
outdated-version-warning = Daha eski bir GuepardOS ISO sürümü kullanıyorsunuz, lütfen kurulumlar için en son sürümü kullanmayı düşünün
...
welcome-title = GuepardOS'e Hoş Geldiniz!
welcome-body =
    Aramıza katıldığınız için size çok teşekkür ederiz!

    GuepardOS Geliştirici Ekibi olarak, bizler yapımında ne kadar zevk aldıysak, sizlerin de GuepardOS'i kullanırken o kadar memnun kalacağınızı umut ediyoruz. Aşağıdaki bağlantılar, yeni işletim sisteminizi kullanma konusunda sizlere yardımcı olacaktır. Bu vesileyle tecrübenizin tadını çıkarın, fikir ve düşüncelerinizi bizlerle paylaşmaktan çekinmeyin.
