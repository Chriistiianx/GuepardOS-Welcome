# O dialogu
about-dialog-title = GuepardOS Vítejte
about-dialog-comments = Úvodní obrazovka pro GuepardOS
...
outdated-version-warning = Používáte starší verzi GuepardOS ISO, zvažte prosím použití nejnovější verze pro instalace
...
welcome-title = Vitejte v GuepardOS!
welcome-body =
    Děkujeme, že jste se přidali k naší komunitě!

    My, vývojáři GuepardOS, doufáme, že budete používat GuepardOS se stejným nadšením, s jakým ho my vytváříme. Odkazy níže vám pomůžou začíť s vaším novým operačním systémem. Užijte si zážitek a neváhajte nám poslat vaší zpětnou vazbu.
