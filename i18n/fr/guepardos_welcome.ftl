...
about-dialog-comments = Écran de bienvenue pour GuepardOS
...
outdated-version-warning = Vous utilisez une ancienne version de l'ISO de GuepardOS, veuillez utiliser la dernière version pour vos installations
...
welcome-title = Bienvenue sur GuepardOS !
welcome-body =
    Merci de rejoindre notre communauté !

    Nous, les développeurs de GuepardOS, espérons que vous aimerez autant GuepardOS que nous avons aimé à le développer. Les liens ci-dessous vous aiderons à prendre en main votre nouveau système d\'exploitation. Profitez donc de l\'expérience, et n'hésitez pas à nous envoyer vos retours.
