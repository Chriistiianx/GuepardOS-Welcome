...
about-dialog-comments = Ekran powitalny GuepardOS
...
outdated-version-warning = Używasz starszej wersji GuepardOS ISO, rozważ użycie najnowszej wersji do instalacji
...
welcome-title = Witaj w GuepardOS!
welcome-body =
    Dziękujemy za dołączenie do naszej społeczności!

    My, programiści GuepardOS, mamy nadzieję, że używanie GuepardOS przyniesie Ci tyle radości ile nam jego tworzenie. Poniższe odnośniki pomogą Ci w rozpoczęciu używania nowego systemu operacyjnego. Życzymy miłych wrażeń, nie wahaj się podzielić się z nami swoją opinią.
