...
about-dialog-comments = Приветственный экран GuepardOS
...
outdated-version-warning = Вы используете устаревшую версию GuepardOS ISO, пожалуйста, рассмотрите возможность использования последней версии для установки
...
welcome-title = Добро пожаловать в GuepardOS!
welcome-body =
    Благодарим Вас за то, что Вы присоединились к нашему сообществу!

    Мы, разработчики GuepardOS, надеемся, что пользуясь этой системой, Вы будете испытывать такое же удовольствие, какое испытывали мы, создавая ее. Представленные ниже ссылки помогут Вам начать работу. Наслаждайтесь функционалом GuepardOS и оставляйте свои отзывы.
