# About dialog
about-dialog-title = Benvinguda del GuepardOS
about-dialog-comments = Pantalla de benvinguda per al GuepardOS
...
outdated-version-warning = Useu una imatge més antiga del GuepardOS. Si us plau, considereu usar-ne la versió més recent per a les instal·lacions.
...
welcome-title = Us donem la benvinguda al GuepardOS!
welcome-body =
    Moltes mercès per unir-vos a la nostra comunitat!

    Nosaltres, els desenvolupadors del GuepardOS, esperem que gaudiu d'usar el GuepardOS tant com a nosaltres ens agrada fer-lo. Els enllaços següents us ajudaran a començar. Gaudiu de l'experiència i no dubteu a enviar-nos-en comentaris.
