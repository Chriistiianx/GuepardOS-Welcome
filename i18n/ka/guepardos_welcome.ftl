...
about-dialog-comments = GuepardOS-ის მისალმების ეკრანი
...
outdated-version-warning = იყენებთ GuepardOS-ის ISO-ის ძველ ვერსიას. სჯობს, ახალი ვერსია გადმოწეროთ
...
welcome-title = კეთილი იყოს თქვენი მობრძანება GuepardOS-ში!
welcome-body =
    მადლობა, რომ შემოუერთდით ჩვენს საზოგადოებას!

    ჩვენ, GuepardOS-ის პროგრამისტები, ვიმედოვნებთ, რომ თქვენ ისე ისიამოვნებთ GuepardOS-ით, როგორც ჩვენ მისი აგებისას. ბმულები ქვემოთ დაგეხმარებათ, თქვენს ახალ ოპერაციულ სისტემასთან მუშაობა დაიწყოთ. ასე რომ, ისიამოვნეთ და ნუ შეიკავებთ თავს, თქვენი აზრი გაგვიზიაროთ.