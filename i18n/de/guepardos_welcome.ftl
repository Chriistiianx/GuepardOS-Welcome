...
about-dialog-comments = Willkommensdialog für GuepardOS
...
outdated-version-warning = Du nutzt eine alte Version von GuepardOS, bitte downloade die letzte Version runter
...
welcome-title = Willkommen bei GuepardOS!
welcome-body =
    Danke, dass du dich unserer Community anschließt!

    Wir, die GuepardOS-Entwickler, hoffen, dass du es genauso sehr genießen wirst, GuepardOS zu benutzen, wie wir es genießen, es zu entwickeln. Die Links unten werden dir helfen dich in deinem neuen Betriebssystem zurechtzufinden. Genieße diese Erfahrung und zögere nicht dein Feedback an uns zu senden.
