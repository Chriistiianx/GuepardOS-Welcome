...
about-dialog-comments = Välkomstskärm för GuepardOS
...
outdated-version-warning = Du använder en äldre version av GuepardOS ISO, överväg att använda den senaste versionen för installationer
...
welcome-title = Välkommen till GuepardOS!
welcome-body =
    Tack för att du ansluter dig till vår gemenskap!

    Vi, GuepardOS-utvecklarna, hoppas att du kommer att tycka om att använda GuepardOS lika mycket som vi tycker om att bygga det. Länkarna nedan hjälper dig att komma igång med ditt nya operativsystem. Så njut av upplevelsen och tveka inte att skicka oss din feedback.