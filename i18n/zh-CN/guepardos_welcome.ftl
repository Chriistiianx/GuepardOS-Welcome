# About dialog
about-dialog-title = GuepardOS 欢迎
about-dialog-comments = GuepardOS 的欢迎界面
...
outdated-version-warning = 您正使用 GuepardOS 的一个旧版 ISO，请考虑使用最新版来安装
...
welcome-title = 欢迎使用 GuepardOS！
welcome-body =
    欢迎您加入我们的社区！

    我们是 GuepardOS 的开发者，希望您能像我们开发一样愉快地使用 GuepardOS！下方的链接将帮助您开始探索您的新操作系统，请尽管享受您的体验，如果您有任何的反馈或意见，不用犹豫！发送给我们！
